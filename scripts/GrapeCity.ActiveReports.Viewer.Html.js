!function (window) {
    ...
    function ArReportService(options, resourceManager) {
        ...
        var SR = resourceManager && $.isFunction(resourceManager.get) ? resourceManager.get : identity, formats = {
            ...
            ping: ping
        }, $base = ReportServiceBase(service, serviceUrl, SR), maxBookmarksCount = 1e5;
        return service;
    }
        ...
        function getResourceId(requestResult) {
            ...
            switch (requestInfo.State) {
              ...
              case requestStates.Rejected:
                ...
                return "GrapeCity.ActiveReports.ReportException" == requestInfo.Exception.Type ? $base.errorPromise(SR("error.ReportException")) : $base.errorPromise(SR("error.RequestRejected") + " " + err);
    ...
    function ReportServiceBase(service, serviceUrl, SR) {
        function isUndefined(value) {
            return void 0 === value || null === value;
        }
        function post(methodName, data, skipError, async) {
            ...
            return (void 0 === async || null === async) && (async = !0), $.ajax({
                ...
                return isUndefined(msg.d) ? invalidResponse(msg) : isUndefined(msg.d.Error) ? msg.d : skipError ? msg.d : errorPromise(msg.d.Error.ErrorCode == ErrorCodes.InternalError ? SR("error.ReportException") : msg.d.Error.Description || "ReportService fail!");
            }).fail(function() {
                var error = resolveErrorMessage(arguments);
    ...
    function ResourceManager() {
        ...
        embedded = {
            ...
            "error.ReportException": "Exception has occured. Please contact system administrator."
        };
        var manager;
        return manager = {
            get: function(key) {
