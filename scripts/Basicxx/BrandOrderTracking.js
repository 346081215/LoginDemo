$(function () {
    ...
    //日历控件
    FormComponents.init();
    $.post("/Basicxx/BrandOrderTrackingLoad", "", function (data) {
    ...
    function GetOrder() {
        ...
        // alert(nowPage);
        var StrHtml = "";
        var url = "/Basicxx/BrandOrderTrackingQuery?psid=" + psid + "&Cusprodcatid=" + Cusprodcatid + "&oos_orderno=" + oos_orderno + "&orderStatus=" + orderStatus + "&Item=" + Item + "&Customer=" + Customer + "&Payment=" + Payment + "&RcDateStart=" + RcDateStart + "&RcDateEnd=" + RcDateEnd + "&DeliveryStartTime=" + DeliveryStartTime + "&DeliveryEndTime=" + DeliveryEndTime + "&pageIndex=" + nowPage;
