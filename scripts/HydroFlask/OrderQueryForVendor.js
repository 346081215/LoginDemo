$(function () {
    ...
    $.post("/HydroFlask/OrderQueryForVendorLoad", "", function (data) {
        if (data.FunStatus == "success") {

            $("#txtVendor").val(data.OrderQueryForVendorLoadData._Vendor)
            $("#VendorID").val(data.OrderQueryForVendorLoadData.VendorID)
    ...
    function GetOrder()
    {
        ...
        var url = "/HydroFlask/GetDataOrderQueryForVendor?BrandId=" + BrandId + "&accountid=" + accountid + "&psid=" + psid + "&po=" + po + "&oos_orderno=" + oos_orderno + "&performance=" + performance + "&orderStatus=" + orderStatus + "&RcDateStart=" + RcDateStart + "&RcDateEnd" + RcDateEnd + "&pageIndex=" + nowPage;
