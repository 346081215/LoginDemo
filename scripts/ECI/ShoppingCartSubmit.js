$(function () {
    ...
    $.post("/ECI/ShoppingCartSubmitLoad", "PrintShopId=" + $("#sprintshop").val() + "&T=" + $("#T").val(), function (data) {
        if (data.FunStatus == "success") {
            ...
            $("#BilltoId").val(data.ShoppingCartSubmitData.BilltoId);
            ...
            debugger;
            $("#ShiptoId").val(data.ShoppingCartSubmitData.ShiptoId);
            $("#ShipAddress").val(data.ShoppingCartSubmitData.ShipAddrId);
            ...
            $.each(data.ShoppingCartSubmitData.ShoppingCartSubmitlist, function (i, item) {
                ...
                shippingcarthtml += "<td class='center' ><img src='" + item.producturl + "'/></td>";
    ...
    $("select[name='ShipAddress']").change(function () {
        var data = {
    ...
    $("#Submit3").click(function () {
        ...
        $("#ok").bind("click", function () {
            ...
            $.post("/ECI/ShoppingCartSubmitOrder", SubmitData, function (data) {
                if (data.FunStatus == "success") {
    ...
    $("#Submit4").click(function () {
        ...
        $.post("/ECI/ShoppingCartItem?PrintShopId=" + $("#sprintshop").val() + "&T=" + $("#T").val(), "", function (html) {
            $("#content").html(html)
        })
    ...
    $("#Submit6").click(function () {
        ...
        $.post("/ECI/ShoppingCartItem?" + "T=" + $("#T").val(), "", function (html) {
            $("#content").html(html)
        })
        ...
        $.post(urlPost, data_, function (data, status) {
            ...
            if (data.FunData != null) {
                $.each(data.FunData, function (i, item) {
                    ...
                    shippingcarthtml += '<td style="display:none" id="shoppingcartid">' + item.ID + "</td>";
                    shippingcarthtml += '<td style="display:none" id="shopingcartproductid">' + i + "</td>";
                    shippingcarthtml += "<td class='center' ><img src='" + item.producturl + "' style='width:100px;height:100px'/></td>";
                    ...
                    shippingcarthtml += "<td class='center'>" + item.Size + "</td>";
                    shippingcarthtml += "<td class='center'>" + item.UOM + "</td>";
                    shippingcarthtml += "<td class='center'></td>";
